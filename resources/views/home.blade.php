            ...
            <div class="container">
                ...
                <div class="row justify-content-center" id="filter-container">
                    <div class="filter-container">
                        ...
                        <a href="javascript:void(0)" class="btn btn-secondary filter-btn-sm" style="margin-top:12px;" id="filter-btn-sm"><i class="fa fa-search"></i></a>
                        ...
                        <div class="py-3 px-4">
                            <div class="form row row-sm filter-box labeltag">
                                ...
                                <div class="form-group select-wrap col-xl-2 col-lg-2 col-md-12 select2-lg mb-0">
                                    ...
                                    <select class="form-control select2-show-search border-bottom-0 filter-select" id="select-tailored" aria-label="Floating label select example" onchange="tailoredoption()">
                                ...
                                <div class="form-group col-xl-2 col-lg-2 col-md-12 select2-lg mb-0">
                                    <select class="form-control select2-show-search  border-bottom-0 filter-select" id="select-capacity"aria-label="Floating label select example" data-placeholder="Capacity" onchange="capacityoption()">
                                ...
                                <div class="form-group col-xl-2 col-lg-2 col-md-12 select2-lg mb-0">
                                    <select class="form-control select2-show-search  border-bottom-0 filter-select" id="select-price" data-placeholder="Price" onchange="priceoption()"> 
                                            <option>Price</option>
                                ...
                                <div class="form-group col-xl-2 col-lg-2 col-md-12 select2-lg mb-0">
                                    <select class="form-control select2-show-search  border-bottom-0 filter-select" id="select-country" data-placeholder="County" onchange="countryoption()">
